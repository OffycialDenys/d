...
<section class="grid grid--2">
    ...
    <article class="card"><h2>Available Rewards</h2><div class="timeline"><?php foreach ($_SESSION['platform']['rewards'] as $row): ?><div class="timeline__item" data-search-row><strong><?= e($row['title']) ?> - <?= e(money($row['amount'])) ?></strong><p class="muted"><?= e($row['code']) ?> / <?= e($row['status']) ?> / expires <?= e($row['expires']) ?></p></div><?php endforeach; ?></div></article>
</section>
